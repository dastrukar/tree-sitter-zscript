...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [425] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_frame_statement_repeat1, 2, .production_id = 27),
  [427] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_frame_statement_repeat1, 2, .production_id = 27),
  [429] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_frame_statement_repeat1, 2, .production_id = 27), SHIFT_REPEAT(121),
  [432] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_frame_statement_repeat1, 2, .production_id = 27), SHIFT_REPEAT(409),
  [435] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_frame_statement_repeat1, 2, .production_id = 27), SHIFT_REPEAT(413),
